    ...
    public void onCreate() {
        ...
        mShakeDetector.setOnShakeListener(new ShakeDetector.OnShakeListener() {
                                              ...
                                              public void onShake(int count) {
                                                  ...
                                                  //the phone for 3 times in a row
                                                  if (count == 3) {
                                                      //vibrate the phone
                                                      vibrate();
                                                      // create FusedLocationProviderClient to get user lociation
                                                      ...
                                                      fusedLocationClient.getCurrentLocation(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, new CancellationToken() {
                                                          ...
                                                          public void onSuccess(Location location) {
                                                              ...
                                                              if (location != null) {
                                                                  ...
                                                                  // get the list of all the contacts in Datebase
                                                                  DbHelper db = new DbHelper(SensorService.this);
                                                                  List<ContactsModel> list = db.getAllContacts();

                                                                  // send sms to each contact
                                                                  for (ContactsModel c : list) {
                                                                      String message = "Hey, " + c.getName() + "I an in Danger, i need help.Please urgently reach me out.Here are my coordinates.\n "
                                                                              + "http://maps.google.com/?q=" + location.getLatitude() + ", " + location.getLongitude();
                                                                      smsManager.sendTextMessage(c.getPhoneNo(), null, message, null, null);
                                                                  }
                                                              } else {
                                                                  String message = "I am in DANGER,i need help.Please urgently reach me out.\n "
                                                                          + "GPS was turned off.Couldn't find location.call your Police Station";
                                                                  SmsManager smsManager = SmsManager.getDefault();
                                                                 DbHelper db = new DbHelper(SensorService.this);
                                                                 List<ContactsModel> list = db.getAllContacts();
                                                                  for (ContactsModel c : list) {
